...
*/
Vue.component("simple_footer_component_1721839455", {
    template: `
            ...
            <div id="footer-container" class="max-w-screen-xl p-4 py-6 mx-auto lg:py-16 md:p-8 lg:p-10">
                ...
                <div class="flex">
                    <div id="footer-text" class="flex-1 block text-sm text-center text-gray-500 dark:text-gray-400">
                        Uncover the latest innovations effortlessly with our cutting-edge product finder app. Stay ahead of the curve and elevate your shopping experience.
                    </div>
                </div>
            </div>
        </footer> 
